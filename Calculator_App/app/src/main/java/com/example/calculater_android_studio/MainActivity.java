package com.example.calculater_android_studio;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    MaterialButton buttonC,buttonOpen,buttonClose,buttonDivide,buttonEquals,buttonMultiply;
    MaterialButton button1,button2,button3,button4,button5,button6,button7,button8,button9,button0;
    MaterialButton buttonDot,buttonMinus,buttonPlus,buttonAc;
    ...
    if (buttonText.equals("C")) {
      ...
      else   dataToCalculate = dataToCalculate.substring(0, dataToCalculate.length() - 1);
    }
    else {
